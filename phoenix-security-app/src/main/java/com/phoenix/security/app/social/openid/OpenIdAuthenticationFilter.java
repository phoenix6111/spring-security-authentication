 ...
 * Description: 参考org.springframework.security.web.authentication.UsernamePasswordAuthenticationFilter
 */
public class OpenIdAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
     ...
     * request.
     *
     * @param openIdParameter the parameter name.
     */
    ...
    /**
     * Sets the parameter name which will be used to obtain the providerId from the login
     * request..
     *
     * @param providerIdParameter the parameter name.
     */
